        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          ...
          <Text
            style={[
              ...
              {
                backgroundColor:
                  item.role === "Contractor" ? "#2563eb" : "#16a34a",
              },
            ]}
          >
            {item.badge}
            ...
            <ScrollView style={{ flex: 1, marginBottom: 10 }}>
              {chatMessages.map((msg, i) => (
                <View
                  ...
                  style={{
                    alignSelf:
                      msg.senderEmail === userEmail ? "flex-end" : "flex-start",
                    marginBottom: 5,
                  }}
                >
                  <View
          ...
          {profileData ? (
            ...
            >
              ...
              <Text style={{ fontWeight: "bold", marginBottom: 6 }}>
                ⭐ {profileData.user.averageRating || 0} / 5 (
                {profileData.user.totalReviews || 0} reviews)
              </Text>
