...
export default function SettingsPage() {
  ...
  const faqDataEnglish = [
    ...
    },
    {
      ...
      answer: "Go to Settings > Change Password and set a new password.",
    },
    {
      question: "How can I add skills?",
      answer: "Open Settings > Manage Skills and add or update your skills.",
    },
    {
      question: "What is the difference between Contractor and Labour?",
      answer: "Contractors post jobs, while labour users apply for jobs.",
    },
    {
    ...
    },
    {
      ...
      answer: "You can contact support through Settings > Contact Support.",
    },
    {
      question: "Is my data secure?",
      answer: "Yes, your data is stored securely and used only when necessary.",
    },
  ];
  ...
  const faqDataUrdu = [
    ...
    },
    {
      ...
      answer: "Settings > Change Password میں جا کر نیا پاس ورڈ سیٹ کریں۔",
    },
    {
    ...
    },
    {
      ...
      answer: "Settings > Contact Support کے ذریعے سپورٹ ٹیم سے رابطہ کریں۔",
    },
    {
  ...
  const FAQItem = ({ item, isUrdu }: any) => {
    ...
    return (
      ...
      >
        ...
        {open && (
          <Text
            style={[styles.faqAnswer, { textAlign: isUrdu ? "right" : "left" }]}
          >
            {item.answer}
          </Text>
        )}
