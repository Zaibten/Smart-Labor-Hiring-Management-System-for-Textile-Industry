...
export default function ChangePasswordScreen({
  ...
  const handleCheckEmail = async () => {
    ...
    try {
      setLoading(true);
      const res = await fetch("http://10.40.23.221:3000/api/forgot-password", {
        method: "POST",
  ...
  const handleResetPassword = async () => {
    ...
    try {
      setLoading(true);
      const res = await fetch("http://10.40.23.221:3000/api/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
          ...
          <View style={styles.form}>
            <TextInput
              style={[
                ...
                }, // lighter bg to indicate disabled
              ]}
        ...
        <Modal visible={showModal} transparent animationType="fade">
          <Animated.View style={[styles.modalOverlay, { opacity: fadeAnim }]}>
            ...
            >
              ...
              >
                <Text
                  style={{ fontSize: 18, fontWeight: "700", color: "#64748b" }}
                >
                  ×
                </Text>
              </TouchableOpacity>
