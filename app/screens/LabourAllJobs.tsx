    ...
    <>
        ...
        >
          <ScrollView>
            ...
            <View style={styles.row}>
              ...
              >
                <Text
                  style={{ color: filters.endDate ? "#111827" : "#9ca3af" }}
                >
          ...
          {filteredJobs.length > 0 ? (
            filteredJobs.map((job) => (
              <View key={job._id} style={styles.jobCard}>
                <Text
                  style={{ color: "#6b7280", fontSize: 12, marginBottom: 5 }}
                >
      ...
      <ChatBot />
        ...
        <BottomTab
          tabs={labourTabs}
          activeTab={
            pathname.includes("LabourAllJobs") ? "Find Jobs" : undefined
          }
          userRole="Labour"
        />
        {/* <ChatBot /> */}
